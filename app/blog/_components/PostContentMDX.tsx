/**
 * PostContentMDX Component
 * Render MDX content dengan React component support
 * Includes BlogImageCarousel dan komponen custom lainnya
 */
...
export function PostContentMDX({ mdxSource }: PostContentMDXProps) {
  useEffect(() => {
